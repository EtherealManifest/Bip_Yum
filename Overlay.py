...
HPBARWIDE = (2 / 3) * WINY
"""The Width of the Healthbar relative to the size of the screen"""
HPBARHIGH = ((1 / 50) * WINX) + 15
"""THe height of the HealthBar, relative to the screen"""
...
class PlayerHealthBar(pygame.sprite.Sprite):
    """Players healthbar, shown on the screen with numbers. Gradually Reduces as health is depleted."""
    ...
    def update(self, target):
        """Checks teh players health and updates the Bar accordingly"""
...
class Overlay(pygame.Surface):
    """Holds all information to be displayed on the screen"""
    ...
    def update(self, target):
        """Updates all components of the Overlay"""
    ...
    def showText(self, text, color=(255, 255, 255), size=12, duration=100):
        """A method meant to show text, currently in development."""
